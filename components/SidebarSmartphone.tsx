...
interface SidebarSmartphoneProps { 
    sidebarOpen: boolean
    setSidebarOpen: (bool: boolean) => void
}

export default function SidebarSmartphone({sidebarOpen, setSidebarOpen}: SidebarSmartphoneProps) {
    return (
    <>        
            ...
            <Dialog as="div" className="fixed inset-0 flex z-40 lg:hidden" onClose={setSidebarOpen}>
                ...
                <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
                    ...
                    <div className="absolute top-0 right-0 -mr-12 pt-2">
                        ...
                        <cst.svg.XIcon className="h-6 w-6 text-white" aria-hidden="true" />
                        </button>
                    </div>
                    </Transition.Child>
